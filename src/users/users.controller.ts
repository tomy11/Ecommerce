...
export class UsersController {
  ...
  @Post()
  async save(@Body() idata: any): Promise<IResponse> {
    try {
  ...
  @Put(':id')
  async update(@Body('id') id: number, idata: any): Promise<IResponse> {
    try {
      const result = await this.usersRepository.update(id, idata);
      const resultData: IResponse = {
